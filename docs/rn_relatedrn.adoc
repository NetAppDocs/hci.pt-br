...
* https://library.netapp.com/ecm/ecm_download_file/ECMLP3362264["Notas de versão do NetApp Element Software 12.9"^]_NOVO_
* https://library.netapp.com/ecm/ecm_download_file/ECMLP2886996["Notas de versão do software NetApp Element 12,8"^]
...
* https://library.netapp.com/ecm/ecm_download_file/ECMLP3344864["Notas de versão do plug-in vCenter 5.5"^]
...
* link:rn_compute_firmware_2.179.0.html["Notas de lançamento do pacote de firmware de computação 2.179.0"]
...
* link:rn_storage_firmware_2.182.0.html["Notas de lançamento do pacote de firmware de armazenamento 2.182.0"]
