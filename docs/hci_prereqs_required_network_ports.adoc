...
| Nó de gerenciamento | Nó de computação BMC/IPMI | 623 UDP | Porta RMCP. Necessário para atualizações de firmware de computação de controle de nuvem híbrida da NetApp. 
