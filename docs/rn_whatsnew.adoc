...
NOTE: O software Element 12.9 é a versão mais recente e inclui atualizações de segurança e de componentes do sistema, melhorias operacionais e resolução de problemas. https://docs.netapp.com/us-en/element-software/concepts/concept_rn_whats_new_element.html["Saiba mais sobre as novidades do Element 12.9"^] .
