...
---
= Notas de lançamento do pacote de firmware de armazenamento 2.164.0
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
O pacote de firmware de armazenamento versão 2.164.0 contém suporte para NIC, Mellanox CX5 16.32.1010 e uma atualização de firmware para a unidade PM9A3.
