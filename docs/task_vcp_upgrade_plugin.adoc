...
O pacote de serviços de gerenciamento 2.22.7 inclui o plug-in Element para vCenter Server 5.0, que contém o plug-in remoto. Se você usa o plug-in Element, deve atualizar para os serviços de gerenciamento 2.22.7 ou posterior para atender à diretiva da VMware que remove o suporte a plug-ins locais. https://kb.vmware.com/s/article/87880["Saiba mais"^] .
