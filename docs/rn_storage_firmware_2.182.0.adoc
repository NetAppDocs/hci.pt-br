...
---
= Notas de lançamento do pacote de firmware de armazenamento 2.182.0
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
O pacote de firmware de armazenamento versão 2.182.0 contém correções gerais de erros.
