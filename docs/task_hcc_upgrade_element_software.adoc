...
[]
====
O pacote de serviços de gerenciamento 2.27 inclui o Element Plug-in para vCenter Server 5.5, que é compatível apenas com o nó de gerenciamento 12.8.  Ao atualizar para os serviços de gerenciamento 2.27, você deve alterar a sequência de atualização e atualizar o pacote de serviços de gerenciamento após atualizar para o Element 12.8 para garantir a compatibilidade entre o nó de gerenciamento e os serviços de gerenciamento.

Se você estiver atualizando para os serviços de gerenciamento 2.21.61 a 2.26.40, será necessário atualizar o pacote de serviços de gerenciamento antes de atualizar para o Element 12.8.
